    ...
    <ol class="inline-flex items-center space-x-1 text-[1rem]">
      ...
      <li class="flex items-center space-x-1">
       ...
       <li class="flex items-center space-x-1">
        ...
        <a href="seating.html" class="text-white font-[600] opacity-50">Seating</a>
      </li>
    </ol>
  </nav>
...
<a href="#" class="active px-15 p-10" data-text="Sofa" style="--delay:5.1s">
              <span>Seating</span>
            </a>
            <a href="#" class="px-15 p-10 flex-shrink-0" data-text="Sofa" style="--delay:5.2s">
              <span>Tables</span>
            </a>
            <a href="#" class="px-15 p-10 flex-shrink-0" data-text="Sofa" style="--delay:5.4s">
              <span>Desks</span>
            </a>
            <a href="#" class="px-15 p-10 flex-shrink-0" data-text="Sofa" style="--delay:5.5s">
              <span>Storage</span>
            </a>
            <a href="#" class="px-15 p-10 flex-shrink-0" data-text="Sofa" style="--delay:5.6s">
              <span>Loungers</span>
            </a>

            <a href="#" class="px-15 p-10 flex-shrink-0" data-text="Sofa" style="--delay:5.7s">
              <span>Accents</span>
            </a>
    </nav>
...
<section  class="relative w-full px-[2rem] lg:px-[10rem] py-20 bg-img bg-[url('../images/white-textture-bg.png')]">
...
<div  class="clearfix masonry-grid"  data-scroll>
  ...
  <!-- Masonry Items -->
     <div class="masonry-item"  data-scroll data-category="sofa">
    <a href="sofas.html" class="block">
      <img src="images/masonry-grid/1.jpg" class="w-full" />
    </a>
  </div>
  <div class="masonry-item"  data-scroll data-category="seating">
    <img src="images/masonry-grid/2.jpg" class="w-full" />
   
  </div>
  <div class="masonry-item"  data-scroll data-category="chairs">
    <img src="images/masonry-grid/3.jpg" class="w-full" />
   
  </div>
  <div class="masonry-item"  data-scroll data-category="tables">
    <img src="images/masonry-grid/4.jpg" class="w-full" />
   
  </div>
  <div class="masonry-item"  data-scroll data-category="tables">
    <img src="images/masonry-grid/5.jpg" class="w-full" />
...
<div  class="flex justify-center mt-10">
 ...
 <section
            ...
            <div class="swiper-wrapper">
              ...
              >
                <img
                  ...
                  class="w-full object-cover h-full product-img"
                />
                <p class="text-secondary text-[1.2rem] mt-4 font-medium opacity-50">
                 Sofas
                </p>
              </div>
              ...
              >
                <img
                  ...
                  class="w-full object-cover h-full product-img"
                />
                <p class="text-secondary text-[1.2rem] mt-4 font-bold">
                 Sofas
                </p>
              </div>
            </div>
  ...
  <li class="flex items-center gap-3">
    <img src="images/icons/phone-icon-white.svg" alt="Phone Icon" class="w-5 h-5">
  ...
  <!-- Email 1 -->
  <li class="flex items-center gap-3">
    <img src="images/icons/email-icon-white.svg" alt="Email Icon" class="w-5 h-5">
