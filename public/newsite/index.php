...
<meta name="twitter:description" content="Experience refined craftsmanship with Arbor – creators of bespoke fitted interiors and joinery for timeless, elegant spaces." />
  ...
  <body class="index home headerScroll">
    <button
      id="scrollTopBtn"
    ...
    <div
      class="overflow-hidden intro fixed w-full h-screen flex items-center justify-center top-0 left-0 z-30 bg-img bg-[url(../images/white-textture-bg.png)]"
    >
  ...
  >
    ...
    <main data-scroll-container>
      <section class="relative w-full h-screen overflow-hidden" data-scroll>
        <!-- Background Image -->
        <img
          src="images/IMG_0134-1.jpg"
          alt="Hero Background"
          class="absolute inset-0 w-full h-full object-cover z-0 hero-sec-img"
        />

        <!-- Tint Overlay -->
        <!-- <div class="absolute inset-0 bg-olive-drab opacity-70 z-10"></div> -->

        <!-- Centered Title -->
        <div
          class="relative z-20 flex items-center justify-center h-full flex-col"
          data-scroll
          data-scroll-speed="-3"
        ...
        >
          ...
          <div class="explore__CTA">
            <a
              href="contact.php"
              class="btn btn-primary btn-large mt-[8vh] block text-center"
            >
        ...
        <!-- <nav class="categories__nav" data-scroll>
    <a href="#">Sofa</a>
    <a href="#">Tables</a>
    <a href="#">Chairs</a>
    <a href="#">Consoles</a>
    ...
    <a href="#">Poufs</a>
      ...
      <div
        class="cat-wrapper absolute w-full z-45 top-0 bg-img bg-[url(../images/white-textture-bg.png)]"
        data-scroll
      >
        <div class="cat-nav-inner">
          <nav class="categories__nav">
            <a href="commercial.php" download class="" >
              <span>Commercial</span>
            </a>
            <a href="residential.php" download class="" >
      ...
      <section
        id="aboutArbor"
        class="aboutArbor px-[3rem] lg:px-[10rem] relative w-full h-auto lg:h-screen bg-img bg-[url(../images/white-textture-bg.png)] pt-[10rem] pb-[10rem] lg:pb-[0rem]"
      >
        <div
          class="grid grid-cols-1 md:grid-cols-[25%_75%] gap-[4vw] p-[2vw] items-start justify-items-end"
        >
          <!-- Left Side -->
          <div
            class="flex flex-col items-start space-y-4 order-2 md:order-none"
          >
            <!-- Image -->
            <img
            ...
            <!-- Below Image Content -->
            <div class="text-secondary mt-[2rem]">
              <p class="mt-2text-[1.125rem] font-light">
                'Arbor' stands for foundation, our<br />
                entire idea revolves around creating<br />
                bespoke luxury furniture that is<br />
                functional & visually aesthetic.<br />
                Because your space deserves more<br /> than mass-produced furniture
          ...
          <!-- Right Side Content -->
          <div
            class="text-left order-1 md:order-none"
            data-scroll
            data-scroll-speed="-2"
          >
            <small class="text-olive-drab mb-[3rem] block"
              >About arbor Decor</small
            >
           ...
           <div class="inline-block">
             <a href="about.php" class="btn btn-primary btn-large mt-[6rem] inline-block text-center">
              <span>View Our Story</span>
            </a>
           </div>

            <!-- <a href="#" class="btn-link mt-[6rem] inline-block"
              >Read Our Story</a
            > -->
          </div>
        </div>
      ...
      <section
        class="relative min-h-[160vh] w-full overflow-hidden parallax-section py-[10rem] lg:mt-10"
      >
        ...
        <div data-scroll data-scroll-speed="-2" class="absolute inset-0 z-0">
          ...
          <small class="text-olive-drab mb-[3rem] block">Products</small>
          <h2 class="heading-1 text-olive-drab">Signature collection</h2>
        </div>

     
        <div
          class=" z-10 h-full flex flex-col items-center justify-center mt-20 md:mt-0"
        >
          <div
            class="absolute top-[40%]  left-[10rem] max-w-[25rem] project-card"
          >
           <img src="images/commercial.jpg" alt="Card 1" class="w-full" />
           <a  href="commercial.php" class="decoration-0 absolute top-0 left-0 w-full h-full bg-[#88888885] flex items-center justify-center">
            
            <h4 class="text-white text-[3rem] font-normal">Commercial</h4>
           </a>
          </div>

         <div
            class="absolute top-[50%]  right-[10rem] max-w-[25rem] project-card"
          >
           <img src="images/residential.jpg" alt="Card 1" class="w-full" />
           <a  href="residential.php" class="decoration-0 absolute top-0 left-0 w-full h-full bg-[#88888885] flex items-center justify-center">
            
            <h4 class="text-white text-[3rem] font-normal">Residential</h4>
           </a>
          </div>
        </div>
      ...
      <section
        class="relative px-[2rem] lg:px-[10rem] w-full bg-img bg-[url('../images/white-textture-bg.png')] pt-[5rem] md:pt-[10rem] pb-[8rem]"
      >
        <small class="text-olive-drab mb-[4rem] block">Features</small>
        ...
        >
          <div
            class="p-4 left-0 lg:w-1/2 w-full"
            id="sticky-content"
            data-scroll
          >
            <h2 class="heading-1 text-olive-drab">
            ...
            <div class="py-[4rem] md:py-[6rem] px-10">
              <img
                src="images/arbor-decor.png"
                alt="Arbor Decor"
                class="w-[15rem]"
                data-scroll
                data-scroll-speed="-1"
          ...
          <div class="p-4 lg:w-1/2 w-full">
            <ul class="divide-y divide-secondary">
              <li class="pb-15">
                <h6 class="text-olive-drab font-bold text-[1.3rem] mb-4">
                 Premium Craftsmanship
                </h6>
                <p class="text-olive-drab font-light">
                  Skilled artisans with decades of experience, deep rooted craftsmanship are trained for modern builds
                </p>
              </li>
              <li class="py-15">
                <h6 class="text-olive-drab font-bold text-[1.3rem] mb-4">
                ...
                <p class="text-olive-drab font-light">
                  We take pride in using ethically sourced materials that safeguard the planet and our people who craft furniture
                </p>
              </li>
              <li class="py-15">
                <h6 class="text-olive-drab font-bold text-[1.3rem] mb-4">
                ...
                <p class="text-olive-drab font-light">
                  Customising furniture gives you control, quality and a deeper connection to the space you live in
                </p>
              </li>
              <li class="py-15">
                <h6 class="text-olive-drab font-bold text-[1.3rem] mb-4">
                ...
                <p class="text-olive-drab font-light">
                  We deliver, install and cater to all cities across India whilst eyeing global markets
                </p>
              </li>

              <li class="py-15">
                <h6 class="text-olive-drab font-bold text-[1.3rem] mb-8">
                Space Planning & Consultation
                </h6>
                <p class="text-olive-drab font-light">
                 From initial consultation to final delivery, you are part of the journey, bringing your vision to life
                </p>
              </li>
            ...
            <div class="text-left mt-5 inline-block">
      ...
      <section
        class="relative w-full bg-[#F2E7DC] pt-[10rem] pb-[5rem] md:pb-[10rem] overflow-hidden"
      >
        <span
          class="absolute right-[20%] top-10 z-20 block"
          data-scroll
          data-scroll-speed="-2.5"
        >
          <img src="images/table.png" alt="" class="w-20 lg:w-60" />
        </span>

        <span
          class="absolute left-[10%] top-20 lg:top-50 z-20 block"
          data-scroll
          data-scroll-speed="-2.5"
        >
          <img src="images/soft-chair.png" alt="" class="w-20 lg:w-60" />
        </span>
        <div
          class="px-[3rem] md:px-[10rem] relative text-center pb-[4rem] md:pb-[7rem]"
          data-scroll
        >
          <small class="text-olive-drab mb-[3rem] block">Get Inspired</small>
          <h2 class="heading-1 text-olive-drab">
            See your<br />
            design dream<br />
            come to life
        ...
        <div class="overflow-hidden w-full" id="scrollTickerContainer">
          <div class="flex ticker-track items-start">
            <div class="w-auto flex flex-col items-center text-center px-4">
              <img
                src="images/inspired/1.jpg"
                alt="Inspiration"
...
that matter</h2>
    ...
    <div class="logo-track scroll-left flex">
      <!-- Original set -->
      <div class="logo-box bg-wheat"> <img src="images/clients/1.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/2.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/3.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/4.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/5.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/6.png" /> </div>
 ...
 <div class="logo-box bg-wheat"> <img src="images/clients/1.png" /> </div>
    ...
    <div class="logo-track scroll-right flex">
      <!-- Original set -->
      <div class="logo-box bg-wheat"> <img src="images/clients/7.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/8.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/9.png" /> </div>
      <div class="logo-box bg-wheat"> <img src="images/clients/10.png" /> </div>
       <div class="logo-box bg-wheat"> <img src="images/clients/11.png" /> </div>
       <div class="logo-box bg-wheat"> <img src="images/clients/12.png" /> </div>
          <div class="logo-box bg-wheat"> <img src="images/clients/13.png" /> </div>
             <div class="logo-box bg-wheat"> <img src="images/clients/14.png" /> </div>
    </div>
    <div class="logo-track scroll-right flex">
      <!-- Duplicate set -->
 <div class="logo-box bg-wheat"> <img src="images/clients/1.png" /> </div>
<div class="logo-box bg-wheat"> <img src="images/clients/7.png" /> </div>
      ...
      >
        <div class="px-[3rem] md:px-[10rem] relative text-center" data-scroll>
          ...
          <h2 class="heading-1 text-olive-drab">What our clients say!</h2>
        </div>

        <div class=" mt-30" id="testimonialSlider">
          <div class="swiper-wrapper md:px-[2rem] md:px-0">
            <!-- Testimonial Slide -->
            ...
            <div class="swiper-slide p-4">
              ...
              <p class="text-secondary py-10 font-normal">
                We worked with Arbor Decor and team for the golden door project. We worked in sync from the word go and created a mammoth of a piece. We appreciate their understanding of client requirement and commitment to quality.
              </p>
            ...
            <div class="swiper-slide p-4">
              ...
              <small>Interior Stylist</small>
              <p class="text-secondary py-10 font-normal">
               It’s been a while since we know you and worked with your team. It’s been a flawless experience. Never a doubt you can’t make something and with streamlined detailing whether customised or ready pick ups. Very hardworking and very enterprising. Always wish u future great endeavours
              </p>
