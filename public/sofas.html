...
/>
    ...
    <header class="header" data-scroll>
      ...
      >
       ...
       <a href="index.html" class="nav-link">Home</a>
            ...
            <a href="commercial.html" class="nav-link active">Commercial</a>
  ...
  <nav class="text-sm text-white relative" aria-label="Breadcrumb" >
    <ol class="inline-flex items-center space-x-1 text-[1rem]">
      <li>
        <a href="#" class="hover:text-white text-white">Home</a>
      </li>
      <li class="flex items-center space-x-1">
        ...
        <a href="commercial.html" class="text-white font-[600] ">Commercial</a>
      </li>
       ...
       <li class="flex items-center space-x-1">
        ...
        <a href="seating.html" class="text-white font-[600] ">Seating</a>
      </li>
        ...
        <a href="sofas.html" class="text-white font-[600] opacity-50">Sofas</a>
      </li>
    </ol>
  </nav>
 ...
 <section
        class="relative bg-white w-full px-[2rem] lg:px-[10rem]  pt-12 md:pt-20 pb-30"
      >

      <div class="space-y-6 p-4">
  <!-- Row 1: 3 columns -->
<div class="grid grid-cols-12 sm:grid-cols-24 gap-5 gallery-grid">
  <div class="order-1 col-span-12 sm:col-span-6">
    <figure  class=" aspect-[1]">
        <img src="images/sofas/1.png" class="w-full h-full object-cover" />
    </figure>
  </div>
  <div class="order-2 col-span-12 sm:col-span-9">
    <figure  class=" aspect-[1]"><img src="images/sofas/2.png" class="w-full h-full object-cover" /></figure></div>
  <div class="order-3 col-span-12 sm:col-span-7 aspect-[1]">  <figure  class=" aspect-[1]"><img src="images/sofas/3.png" class="w-full h-full object-cover" /></figure></div>
</div>


  <!-- Row 2: 3 columns -->
  <div class="grid grid-cols-12 sm:grid-cols-24 gap-5 gallery-grid sm:pt-12">
<div class="order-1 col-span-12 sm:col-span-8 ">
       <figure  class="aspect-[1]"><img src="images/sofas/4.jpg" class="w-full h-full object-cover" /></figure></div>
  <div class="order-2 col-span-12 sm:col-span-10">
      <figure  class=" aspect-[1]"><img src="images/sofas/5.png" class="w-full h-full object-cover" /></figure></div>
  <div class="order-3 col-span-12 sm:col-span-5 ">
     <figure  class="aspect-[2/3]"><img src="images/sofas/6.png" class="w-full h-full object-cover" /></figure></div>
  </div>


    <div class="grid grid-cols-12 sm:grid-cols-24 gap-5 gallery-grid sm:pt-12">
<div class="order-1 col-span-12 sm:col-span-5 ">
       <figure  class=""><img src="images/sofas/7.jpg" class="w-full h-full object-cover" /></figure></div>
  <div class="order-2 col-span-12 sm:col-span-8">
      <figure  class=""><img src="images/sofas/8.png" class="w-full h-full object-cover" /></figure></div>
  <div class="order-3 col-span-12 sm:col-span-5 ">
     <figure  class=""><img src="images/sofas/9.png" class="w-full h-full object-cover" /></figure></div>

       <div class="order-4 col-span-12 sm:col-span-5 ">
     <figure  class="aspect-[1]"><img src="images/sofas/10.png" class="w-full h-full object-cover" /></figure></div>
  </div>
...
<div class="grid grid-cols-12 sm:grid-cols-24 gap-5 gallery-grid sm:pt-12">
  ...
  <div class="order-2 col-span-12 sm:col-span-9">
    <figure  class=" aspect-[1]"><img src="images/sofas/2.png" class="w-full h-full object-cover" /></figure></div>
  <div class="order-3 col-span-12 sm:col-span-7 ">  <figure  class=" aspect-[1]"><img src="images/sofas/4.png" class="w-full h-full object-cover" /></figure></div>
</div>
        ...
        >
          <div class="grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-50">
            ...
            <div>
              ...
              <ul class="flex flex-col gap-4  text-[1.2rem] font-normal text-white mt-10 mb-12">
  <!-- Phone -->
  <li class="flex items-center gap-3">
    <img src="images/icons/phone.svg" alt="Phone Icon" class="w-5 h-5 invert-0">
    <a href="tel:+919820506004" class="hover:text-white transition-colors">
      +91-9820506004
    </a>
  </li>
  ...
  <!-- Email 1 -->
  <li class="flex items-center gap-3">
    <img src="images/icons/email.svg" alt="Email Icon" class="w-5 h-5 invert-0">
    <a href="mailto:info@arbordecor.in" class="hover:text-white transition-colors">
      info@arbordecor.in
    </a>
  </li>
  ...
  <li class="flex items-center gap-3">
    <img src="images/icons/email.svg" alt="Email Icon" class="w-5 h-5 invert-0">
    <a href="mailto:arbordecormumbai@gmail.com" class="hover:text-white transition-colors">
